    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            if(f.exists())
            {
                ...
                hotelManagement.hotel_ob=(holder)ois.readObject();
            }
            ...
            do{
                ...
                switch(ch){
                    case 1: System.out.println("\nChoose room type :\n1.Luxury Double Room \n2.Deluxe Double Room \n3.Luxury Single Room \n4.Deluxe Single Room\n");
                        ch2 = sc.nextInt();
                        hotelManagement.features(ch2);
                        break;
                    case 2:System.out.println("\nChoose room type :\n1.Luxury Double Room \n2.Deluxe Double Room \n3.Luxury Single Room\n4.Deluxe Single Room\n");
                        ch2 = sc.nextInt();
                        hotelManagement.availability(ch2);
                        break;
                    case 3:System.out.println("\nChoose room type :\n1.Luxury Double Room \n2.Deluxe Double Room \n3.Luxury Single Room\n4.Deluxe Single Room\n");
                        ch2 = sc.nextInt();
                        hotelManagement.bookroom(ch2);
                        break;
                    case 4:
                        ...
                        if(ch2>60)
                            ...
                            hotelManagement.order(ch2-41,4);
                        else if(ch2>30)
                            hotelManagement.order(ch2-31,3);
                        else if(ch2>10)
                            hotelManagement.order(ch2-11,2);
                        else if(ch2>0)
                            hotelManagement.order(ch2-1,1);
                        else
                            System.out.println("Room doesn't exist");
                        break;
                    case 5:
                        ...
                        if(ch2>60)
                            ...
                            hotelManagement.deallocate(ch2-41,4);
                        else if(ch2>30)
                            hotelManagement.deallocate(ch2-31,3);
                        else if(ch2>10)
                            hotelManagement.deallocate(ch2-11,2);
                        else if(ch2>0)
                            hotelManagement.deallocate(ch2-1,1);
                        else
                            System.out.println("Room doesn't exist");
                        break;
                    case 6:break x;
            ...
            Thread t=new Thread(new write(hotelManagement.hotel_ob));
            t.start();
        }
        catch(Exception e)
        {
